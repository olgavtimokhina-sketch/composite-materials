...
методом опорных векторов, методом случайного леса, методом линейной регрессии, методом градиентного бустинга, методом К ближайших соседей, методом деревья решений, методом стохастического градиентного спуска, методом многослойного перцептрона
...
Автор: Тимохина Ольга Владимировна
